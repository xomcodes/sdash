...
export const ActivityChart = () => {
  return (
    <section className=" flex flex-col py-[clamp(14px,1.9vw,28px)] px-[clamp(12px,1.6vw,24px)] bg-white dark:bg-my-blue  w-[19%] rounded-xl max-[1370px]:w-full  ">
      ...
      <Divider />
      <section className=" flex flex-col  max-[1370px]:inline-flex">
